          ...
          <div class="col-md-12"><br />
              <div class="list-group">
                ...
                <div class="list-group-item list-group-item-action d-flex gap-3 py-3" aria-current="true" >
                  <div class="d-flex gap-2 w-100 justify-content-between">
                    <div class="">
                      <h6 class="mb-0">Credits (Not sponsored)(Please buy if you are going to use)</h6>
                      <p class="mb-0 opacity-75">
                        Userspice (kinda free lol) <br />
                        Brevo (kinda free lol)<br />
                        <a href="https://bootstrapmade.com/niceshop-bootstrap-ecommerce-template/">BootstrapMade (Theme cause i just cant) ($19 USD)</a><br />
                        <a href="https://www.creativefabrica.com/product/one-little/">One Little font ($8 USD)</a><br />
                      </p>
                    </div>
                  </div>
                </div>
