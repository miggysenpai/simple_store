        ...
        if($page_id == "edit_product"){
            ...
            if($_POST){ 
                ...
                if($post_type == "upload_zip"){
                    ...
                    //insert blank in simple_store_products_downloads
                    $fields = [
                        'product_id' => $_GET["product_id"],
                        ];
                    $result = $db->insert("simple_store_products_downloads", $fields);
                    $id = $db->lastId(); //get lastID
                    
                    //Upload downloadable file 
                    $uploadfile = $uploaddir . "prod_".$_GET["product_id"] ."_download_".$id.".".$imageFileType;
                    $uploadfile_name = "prod_".$_GET["product_id"] ."_download_".$id.".".$imageFileType;;
                    echo '<pre>';
                    ...
                    //prepping fields for database
                    $fields = [
                    'download' => $uploadfile_name,
                    ];
                    $result = $db->update('simple_store_products_downloads', $id, $fields); //updates database 
                     header("Location: store_admin.php?id=edit_product&product_id=".$_GET["product_id"]); // redirects to product page once completed
                     die();
                }
                ...
                <h3 class='text-center'>Edit Product</h3>
                 ...
                 <section id='cart' class='cart section'>
                  ...
                  <div class='col-lg-12' >
                    ...
                    $products_downloads = $db->query("SELECT * FROM simple_store_products_downloads WHERE product_id = ? ", [$_GET["product_id"]])->results(); // get downloads 
                    ...
                    if(count($products_downloads) === 0){
                                echo '<div class="alert alert-danger" role="alert">
                                        Please Upload atleast a zip file.
                                      </div>';
                            } 
                          ...
                          <div class='col-lg-12 col-12'>
                            <div class='product-info d-flex '>
                              ...
                              <form method='POST' action='?id=edit_product&product_id=".$_GET["product_id"]."&post=general'>
                                ...
                                <br />
                                <span  class='text-secondary d-none'>Color : </span>
                                      <select class='form-control d-none' name='product_color' id='product_color'>
                                        <?php
                            ...
                            if(count($products_downloads) === 0){
                                ...
                                foreach($products_downloads as $product_d){
                                    echo "
                                        <div class='product-info row'>
                                        <span class='text-secondary'>Download ".$products_downloads_count."  : </span>
                                        
                                        <div>
                                            <a href='/downloads/index.php?id=".$product_d->id."' alt='Product' class='btn btn-secondary' loading='lazy'>Download</a>
                                            <br/><br />
                                            <a href='?id=edit_product&product_id=".$_GET["product_id"]."&download_id=".$product_d->id."&post=delete_download' class='btn btn-danger' aria-label='Delete Prodduct Download link'>Delete Zip</a>
                                            <br /><br />
                                        </div>
                                         <br/><br />
                                        </div>   
                            ...
                            echo "
                                <div class='alert alert-secondary' role='alert'>
                                    Upload Your Zip Downloadable File <br />
                                    Be aware of your max upload size. You can change that in you ini.php - Current max upload is ".ini_get("upload_max_filesize")."
                                </div>
                                <form method='POST' action='?id=edit_product&product_id=".$_GET["product_id"]."&post=upload_zip' enctype='multipart/form-data'>
                                    <input type='file' id='zip_upload' name='zip_upload'>
                                    <br /><br />
                                    <button type='submit' name='zip_form' value='zip_form' class='btn btn-success border rounded'>Upload Zip File</button>
                                    <br /><br />
                                </form>
                                <hr /><br />
                            ...
                            <div class='cart-item' >
                                ...
                                if (count($products_variant) === 0) {
                                    echo "<div class='alert alert-danger' role='alert'>
                                            You need atleast one variant for this to work.
                                            <br /><br />
                                           <a href='?id=add_variant&product_id=".$product_info->id."&post=add' class='btn btn-light w-100' aria-label='Add variant Page'>Add a variant</a>
                                          </div>";
                                } else {
                            ...
                            <br />
                            <a href='product.php?id=".$product_info->id."' class='btn btn-success w-100' aria-label='Go to Product Page'>Go to Product Page</a>
                                ...
                                <div class='product-info d-flex '>
                                  <div class='product-details'>
                                     <p class='text-center'>
                                        ...
                                        <br /><br />
                                        <a class='btn btn-danger' href='?id=delete_varient&product_id=".$_GET["product_id"]."&varient_id=".$_GET["varient_id"]."&confirm=true' aria-label='Delete Product Variant'>Delete Product Variant</a>
                                     </p>
                                  </div>
                                </div>
        ...
        if($page_id == "add_product"){
             ...
             if($add_confirm == "add"){
                ...
                $product = $stripe->products->create([
                  ...
                  'tax_code' => "txcd_99999999", // you may have to update this for your specific needs
                  'default_price_data' => [
                    'unit_amount' => $_POST['product_price']*100,
                    'currency' => 'usd', // you may have to update this based on your needs
                  ],
                  'expand' => ['default_price'],
                ]);
