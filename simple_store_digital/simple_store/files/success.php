                                    ...
                                    foreach($products_downloads as $product_d){
                                        echo "
                                            <div class=' item-details row'>
                                              ...
                                              <div class='col-6'><a href='/downloads/index.php?id=".$product_d->id."&order_number=".$receipt_number."&order_email=".$session->customer_details->email."' alt='Product' class='btn btn-secondary w-100' loading='lazy'>Download</a></div>
                                            </div>
                                            <br />
                                        ";
