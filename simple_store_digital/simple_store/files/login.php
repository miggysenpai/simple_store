        ...
        <div class="row justify-content-center"> 
            <div class="auth-container" data-aos="fade-in" data-aos-delay="200">
                ...
                <div class="form-header">
                    <h3><?= $awaitingTOTP ? "Two-Factor Authentication" : lang("SIGNIN_TITLE") ?></h3>
                </div>
                <div class="modal-body p-3">
                    ...
                    <?php elseif ($allowPasswords): ?>
                        <form name="login" id="login-form" class="form-signin auth-form login-form active" method="post" action="">
                            <?= tokenHere(); ?>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" id="username" name="username" placeholder="<?= lang("SIGNIN_UORE") ?>"
                                    value="<?= isset($_POST['username']) ? safeReturn(Input::get('username')) : '' ?>" required autocomplete="username">
                            </div>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="password" class="form-control" placeholder="Password" required id="password" name="password" autocomplete="current-password">
                                <span class="password-toggle see-pw" id="togglePassword">
                                  <i class="bi bi-eye"></i>
                                </span>
                            </div>
                            ...
                            <button class="submit col-12 auth-btn primary-btn " id="next_button" type="submit">
                                <?= lang("SIGNIN_BUTTONTEXT") ?> <i class="bi bi-arrow-right-short"></i>
                            </button>
                        </form>
                    <?php endif; ?>
...
<?php  require_once '../usersc/plugins/simple_store/assets/template/'.'views/footer.php'; // Custom Feader ?>
