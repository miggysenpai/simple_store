...
<head>
    ...
    <title>Login Page - <?php echo $settings->site_name;?></title>
    <!-- Vendor CSS Files -->
        ...
        <div class="row justify-content-center">
          ...
          ?>
            <form name="login" id="login-form" class="form-signin" method="post">
              ...
              <button class="submit form-control btn border rounded submit px-3" id="next_button" type="submit"><i class="fa fa-sign-in"></i> <?= lang("SIGNIN_BUTTONTEXT", ""); ?></button>
            </form>
