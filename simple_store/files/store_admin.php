...
<head>
    ...
    <title>Store Admin Page - <?php echo $settings->site_name;?></title>
    <!-- Vendor CSS Files -->
                  ...
                  <div class="row justify-content-md-center">
                      <div class="col-md-12">
                        <div class="search-widget ">
                          <form action="store_admin.php?id=products&search=search" method="POST">
                                  ...
                                  <div class="col-lg-8 col-12 mb-3 mb-lg-0">
                                    <div class="product-info d-flex ">
                                      ...
                                      <div class="product-details">
                                        ...
                                        <br />
                                        <span class='text-secondary'>Description : </span><span><?=$p->description?></span>
                                      </div>
                          ...
                          <div class='col-lg-12 col-12'>
                            <div class='product-info d-flex '>
                              ...
                              <form method='POST' action='?id=edit_product&product_id=".$_GET["product_id"]."&post=general'>
                                <span class='text-secondary'>Product Name  : </span><input type='text' class='form-control' id='product_name' name='product_name' value='".$product_info->name."' required></span>
                                <br />
                                ...
                                <span class='text-secondary' >Description : </span><textarea  rows='5' class='form-control' id='product_description' name='product_description' value='' >".$product_info->description."</textarea></span>
                                <br />
                            ...
                            <div class='cart-header d-none d-lg-block'>
                                <div class='row align-items-center gy-4'>
                                  ...
                                  <div class='col-lg-2'>
                                    <a href='?id=add_variant&product_id=".$product_info->id."' class='btn border rounded' aria-label='Add varient Page'>Add a varient</a>
                                  </div>
                                </div>
                            </div>
                            <div class='cart-item' >
                                ...
                                ?>
                                  ...
                                  <div class='col-lg-2 col-2'>  
                                    <a href='?id=delete_varient&varient_id=<?=$product_v->id?>' class='btn btn-danger' aria-label='Delete Varient'>delete</a>
                                  </div>
                                  <br /> <br />
                                 <?php } }
...
//***** ADD VARIANT
        if($page_id == "add_variant"){
            ...
            <div class='order-confirmation-1'>
              <div class='next-steps  p-4'  >
                <h3 class='text-center'>Add Product Varient</h3>
            ...
            // double checks if delete confirm
             ...
             if($delete_confirm == "true"){
                 $result = $db->delete('simple_store_products_variants', ["id", "=", $_GET["varient_id"]]); // delete from database
                  header("Location: store_admin.php?id=products"); // redirect to product page
                  die();
             }
            echo "
            <div class='order-confirmation-1'>
              <div class='next-steps  p-4'  >
                <h3 class='text-center'>Delete Product Varient</h3>
                 <section id='cart' class='cart section'>
                 <br />
                 <p class='text-center'>
                    Are you sure you want to delete?
                    <br /><br />
                    <a class='btn btn-danger' href='?id=delete_varient&varient_id=".$_GET["varient_id"]."&confirm=true' aria-label='Delete Product Varient'>Delete Product Varient</a>
                 </p>
                </div>
            </div>
                          ...
                          <div class='col-lg-12 col-12'>
                            <div class='product-info d-flex '>
                              ...
                              <form method='POST' action='?id=add_product&post=add'>
                                <span class='text-secondary'>Product Name  : </span><input type='text' class='form-control' id='product_name' name='product_name' required></span>
                                <br />
                                <span class='text-secondary'>Catergory : </span>
                                <select class='form-control' name='product_catergory' id='product_catergory'>";
                                ...
                                <br />";?>
                                <span class='text-secondary'>Price : </span><input type='text' class='form-control' id='product_price' name='product_price' oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" required></span>
                                <br />
                                <span  class='text-secondary'>Color : </span>
                                      <select class='form-control' name='product_color' id='product_color'>
                                <?php
                                ...
                                <br />
                                <span class='text-secondary' >Description : </span><textarea  rows='5' class='form-control' id='product_description' name='product_description' value='' ></textarea></span>
                                <br />
                ...
                <div class="order-confirmation-1">
                      <div class="next-steps  p-4"  >
                        <h3 class="text-center">Search Orders</h3>
                          <div class="container" >
                              <a class="btn btn-secondary" href="store_admin.php?id=orders" aria-label="Go to Store Orders Page">Back to Orders Page</a> <br/><br/>
...
##### Send email    
               ...
               $brevo_check = $db->query("SELECT * FROM simple_store_brevo")->first(); // get keys
                ...
                $sendSmtpEmail = new \Brevo\Client\Model\SendSmtpEmail([
                 ...
                 'to' => [[ 'name' => $order_info->customer_name, 'email' => $order_info->customer_email]],
                ...
                'params' => ['siteName' => $settings->site_name, 'orderNumber' => $order_info->receipt_number, 'orderCarrier' => $_POST['shipping_carrier'], 'orderTracking' =>$_POST['shipping_tracking'], 'addressLine1' => $order_info->address_line1, 'addressLine2' => $order_info->address_line2, 'addressCity' => $order_info->address_city, 'addressState' => $order_info->address_state, 'addressPostalCode' => $order_info->address_postal_code, 'contactEmail' => $contact_email->contact_email,  'domainName' => $_SERVER['SERVER_NAME'], 'brevoImage' =>$brevo_check->brevo_image,],
              ...
              <div class='next-steps  p-4'  >
                <h3 class='text-center'>Orders</h3>
                 <section id='cart' class='cart section'>
                  ...
                  if (count($stripe_transactions) === 0) { echo ""; } else {
                  echo "
                    <div class='container'>
                      <div class='row gy-4'>
                        <div class='col-md-4'>
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="copyright text-center">
          ...
          <br />
          <?php if(isAdmin()){echo '<a href="users/admin.php" class="btn rounded border" aria-label="Admin Page"> <span>Admin</span> </a> <a href="store_admin.php" class="btn rounded border" aria-label="Store Admin Page"> <span>Store Admin</span> </a> <a href="users/logout.php" class="btn rounded border" aria-label="Logout"> <span>Logout</span> </a>';  } ?>
        </div>
      </div>
    </div>
  </footer>  
